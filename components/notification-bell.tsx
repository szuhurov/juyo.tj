  ...
  return (
    <Link href="/notifications" onClick={() => markAllSeen()}>
      <Button
        ...
        className="relative h-9 w-9 min-[640px]:h-10 min-[640px]:w-10 min-[1084px]:h-11 min-[1084px]:w-11 min-[1920px]:h-12 min-[1920px]:w-12 p-0 rounded-md border-none shadow-none bg-white dark:bg-zinc-900"
      >
