...
export function NotificationBell() {
  ...
  return (
    <Link href="/notifications">
      ...
      >
        <Bell className="h-4 w-4 sm:h-[18px] sm:w-[18px] min-[1084px]:h-5 min-[1084px]:w-5 min-[1920px]:h-[22px] min-[1920px]:w-[22px] text-slate-500 dark:text-zinc-400" />
        {count > 0 && (
          <span className="absolute -top-1 -right-1 h-4 min-w-4 min-[1084px]:h-[18px] min-[1084px]:min-w-[18px] min-[1920px]:h-5 min-[1920px]:min-w-5 px-1 rounded-full bg-red-500 text-white text-[9px] min-[1084px]:text-[10px] min-[1920px]:text-[11px] font-medium flex items-center justify-center">
            {count > 9 ? "9+" : count}
          </span>
        )}
      </Button>
