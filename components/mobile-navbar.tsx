...
export function MobileNavbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[70] bg-white/80 backdrop-blur-lg border-t border-zinc-100 dark:bg-zinc-950/80 dark:border-zinc-900 md:hidden pb-safe">
