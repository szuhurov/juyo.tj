...
export function PostEditForm({ item }: { item: AdminPostDetail["item"] }) {
  ...
  return (
    <div className="rounded-md border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-5 space-y-4">
      <h3 className="text-sm font-semibold text-zinc-900 dark:text-white">Таҳрир кардан</h3>
      ...
      <label className="flex items-center gap-2.5 cursor-pointer w-fit">
        ...
        />
        <span className="text-sm font-semibold text-zinc-700 dark:text-zinc-300">Ҳалшуда ҳисоб карда шавад</span>
      </label>
