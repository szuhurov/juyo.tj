...
export function DeletedPostsArchive({ userId }: { userId?: string } = {}) {
  ...
  if (rows.length === 0) {
    return <p className="py-16 text-center text-sm font-semibold text-zinc-400">Ягон эълони нестшуда нест</p>;
  }
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-zinc-800 dark:text-zinc-100 group-hover:text-white truncate">{row.title}</p>
