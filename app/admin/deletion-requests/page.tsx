    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-4 space-y-4">
        ...
        {isError ? (
          ...
          <p className="py-16 text-center text-sm font-semibold text-zinc-400">Ягон дархост нест</p>
        ) : (
          <div className="space-y-2">
            {data.requests.map((r) => (
              <div
              ...
              >
                <div className="min-w-0 space-y-1">
                  <p className="font-semibold text-sm min-[1084px]:text-base text-zinc-900 dark:text-white">{r.email}</p>
                ...
                {r.status === "pending" && (
                  <div className="flex items-center gap-2 shrink-0">
                    <Button
                      ...
                      className="h-9 min-[1084px]:h-10 rounded-md font-medium text-[9px] min-[1084px]:text-[10px] tracking-widest gap-1.5"
                    >
                    ...
                    <Button
                      ...
                      className="h-9 min-[1084px]:h-10 rounded-md font-medium text-[9px] min-[1084px]:text-[10px] tracking-widest gap-1.5 bg-emerald-500 hover:bg-emerald-600"
                    >
