  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-lg min-[1084px]:text-xl font-bold text-zinc-900 dark:text-white">Шикоятҳо (Reports)</h1>
      </div>
              ...
              >
                <div className="min-w-0 space-y-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="px-2 py-0.5 rounded-md bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 text-[10px] min-[1084px]:text-[11px] font-bold tracking-wider">
                      {REASON_LABELS[r.reason] ?? r.reason}
                    </span>
                    <Link
                      href={`/admin/posts/${r.item_id}`}
                      className="font-bold text-sm min-[1084px]:text-base text-zinc-900 dark:text-white hover:text-blue-600 inline-flex items-center gap-1"
                    >
