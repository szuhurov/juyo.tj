...
} satisfies Record<string, { title: string; lastUpdated: string; intro: string; sections: { title: string; text: string }[] }>;
...
export function PrivacyContent() {
  ...
  return (
    <div className="max-w-3xl mx-auto my-6 px-5 sm:px-8 py-10 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700">
