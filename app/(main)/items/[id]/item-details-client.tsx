...
export default function ItemDetailsClient({ id }: { id: string }) {
  ...
  if (loading) return <div className="mx-auto max-w-6xl md:pt-8 px-4 py-4 md:px-4"><Skeleton className="w-full aspect-square rounded-[32px]" /></div>;
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  {item.profiles?.last_name && (
                    <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-tight">{item.profiles.last_name}</p>
                  )}
                </div>
              </div>
