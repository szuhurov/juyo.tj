...
export const translations: Record<string, any> = {
  tg: {
    ...
    phoneRequiredDesc: 'Лутфан рақами телефони худ ва рақами ягон наздикатонро ворид кунед, то ёбандагон тавонанд бо шумо ҳамеша дар тамос бошанд.',
  ...
  ru: {
    ...
    phoneRequiredDesc: 'Пожалуйста, введите ваш номер телефона и номер кого-то из близких, чтобы нашедшие могли связаться с вами в любое время.',
  ...
  en: {
    ...
    phoneRequiredDesc: 'Please enter your phone number and a secondary number of someone close to you, so finders can contact you anytime.',
