 ...
 */
// Тугмаҳои амали зуд аз бари fixed БЕРУН бароварда шуданд (ҳоло дар
// мӯҳтавои скроллшаванда), пас бар кӯтоҳтар шуд ва ин рақамҳо низ.
//
// ДИҚҚАТ: ҳамаи зинаҳо бояд ЯК НАВЪИ variant бошанд (ҳамааш `min-[…px]`).
// Омехтани `md:`-и номдор бо `min-[1084px]`-и ихтиёрӣ хато медиҳад: Tailwind
// онҳоро ба тартиби гуногун мечинад ва `md:` дар паҳноиҳои калон боло мезад —
// натиҷа ин буд, ки `pt` дар 1920px ҳам 168 мемонд ва фосила ба 2px мефуромад.
//
// Рақамҳо ЧЕНКАРДАШУДАанд — фосилаи бар→плиткаҳо 6px, ҳамон фосилае, ки
// байни қатори навъ ва қатори категория аст:
//   ≤767   бар 118 → 76
//   768+   бар 150 → 92
// Тугмаҳои амали зуд ДАРУНИ бари fixed-анд (дар ҷои худ меистанд, зери
// филтрҳо намераванд), пас бар баланд аст ва ин рақамҳо низ.
//
// ДИҚҚАТ: ҳамаи зинаҳо бояд ЯК НАВЪИ variant бошанд (ҳамааш `min-[…px]`).
// Омехтани `md:`-и номдор бо `min-[1084px]`-и ихтиёрӣ хато медиҳад: Tailwind
// онҳоро ба тартиби гуногун мечинад ва `md:` дар паҳноиҳои калон боло мезад.
//
// Рақамҳо ЧЕНКАРДАШУДАанд (баландии воқеии бар + фосила):
//   ≤767   бар 174 → 134  (8px)
//   768+   бар 206 → 156  (14px)
//   1920+  бар 216 → 166  (14px)
export const HOME_CONTENT_PT =
  "pt-[134px] min-[768px]:pt-[156px] min-[1920px]:pt-[166px]";
