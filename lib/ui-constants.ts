 ...
 */
// Фосилаи бар→кортҳо: 8px дар mobile, 14px аз 768px боло — дар экрани калон
// 8px хеле танг менамуд ва кортҳо ба филтр часпида буданд.
//
...
//
// Рақамҳо ЧЕНКАРДАШУДАанд (баландии воқеии бари fixed + 14px):
//   ≤767   бар 186 → 146   (8px, mobile)
//   768+   бар 218 → 168
//   1503+  бар 226 → 176
//   1920+  бар 230 → 180
export const HOME_CONTENT_PT =
  "pt-[146px] min-[768px]:pt-[168px] " +
  "min-[1503px]:pt-[176px] min-[1920px]:pt-[180px]";
